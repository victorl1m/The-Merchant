      ...
      <ul className="topbar-container">
        <Link to={`/`}>
          <li className="topbar-logo">
            ...
            <h1 className="topbar-text">The Merchant</h1>
          </li>
        </Link>
        <li className="topbar-elements">
        <Link to={`/`}>
          <button className="topbar-element">Products</button>
        </Link>
        <Link to={`/register`}>
          <button className="topbar-element">Register a Product</button>
          </Link>
        </li>
      </ul>
    </div>
